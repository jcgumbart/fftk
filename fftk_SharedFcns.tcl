#
# $Id: fftk_SharedFcns.tcl,v 1.20 2024/01/11 23:29:55 gumbart Exp $
#
...
proc ::ForceFieldToolKit::SharedFcns::checkWhichQM { outFile } {
    # Check if the QM output file was generated by Gaussian or ORCA or Psi4
	...
	# Check if ORCA
	       ...
	       set NameQM "ORCA"
      	       break
	} elseif { [string match -nocase "*Psi4*" $line] } { 
	       set NameQM "Psi4"
      	       break
	}
    }
    ...
    if { $NameQM ne $qmSoft && ( $NameQM eq "Gaussian" || $NameQM eq "ORCA" || $NameQM eq "Psi4" ) } {
    ...
    # Print message if file was not recognised
       } elseif { ! ($NameQM eq "Gaussian" || $NameQM eq "ORCA" || $NameQM eq "Psi4") } {
